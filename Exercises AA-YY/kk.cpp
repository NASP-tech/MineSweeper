...
*/
/*
Hacer una función en C++ que, dada una matriz M, use g) para generar un número entre 1 y 4, de
manera que:
...
int main()
{
    ...
    arreglo[0][0] = 1;
    arreglo[1][1] = 2;
    llenarUnoFF(arreglo, 2, 1, 9, desplaza.first);    
    cout << "Resultado 1: ";
    cout << arreglo[6][7] << endl;
    llenarUnoFF(arreglo, 2, 1, 9, desplaza.second);
    cout << "Resultado 2: ";
    cout << arreglo[6][7] << endl;
    return 0;
}
