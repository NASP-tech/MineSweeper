...
*/
/*
Modificar los casos aa), bb), cc) y dd) para que, coloque los 1 en la celda dada y en 5 celdas en la
dirección indicada.
*/
#include <iostream>
using namespace std;

void llenarUnoII(int myArray[10][10], int fila, int columna, int numFilas, int direccion)
{
            ...
            if (columna + 1 <= columnas)
            {
                ...
                if (columna + 2 <= columnas)
                {
                    ...
                    if (columna + 3 <= columnas)
                    {
                        ...
                        {
                            myArray[fila][columna + 4] = 1;
                            if (columna + 5 <= columnas)
                            {
                                myArray[fila][columna + 5] = 1;
                            }
                        }
                    }
                }
...
int main()
{
    ...
    arreglo[0][0] = 1;
    arreglo[1][1] = 2;
    llenarUnoII(arreglo, 2, 1, 9, desplaza);
    cout << "Resultado: ";
