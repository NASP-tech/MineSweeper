...
*/
/*
Modificar los casos aa), bb), cc) y dd) para que, coloque los 1 en la celda dada y en 3 celdas en la
dirección indicada.
*/
#include <iostream>
using namespace std;

void llenarUnoGG(int myArray[10][10], int fila, int columna, int numFilas, int direccion)
{
...
int main()
{
    ...
    arreglo[0][0] = 1;
    arreglo[1][1] = 2;
    llenarUnoGG(arreglo, 2, 1, 9, desplaza);
    cout << "Resultado: ";
