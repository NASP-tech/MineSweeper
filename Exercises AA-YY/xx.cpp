...
*/
/*
Hacer una función en C++ que dado un archivo de texto llamado “data.csv”, que por cada fila tiene
...
int main(void) {
    std::ofstream myFile("xxMyCSV.csv");
    ...
    */
    ...
    myFile << "Apple" << endl;
    myFile << "nmkdis" << endl;
    myFile << "Consecutive" << endl;
    myFile << "Consecutive" << endl;
    myFile << "snadiksanl" << endl;
    myFile << "Pronouns" << endl;
    myFile << "Pronouns" << endl;
    myFile << "sndjuasnisa" << endl;
    myFile << "Hungry" << endl;
    myFile << "Hungry" << endl;
    myFile << "askansd" << endl;
    myFile << "Programming" << endl;
    myFile << "Programming" << endl;
    myFile << "nstdgs" << endl;
    myFile.close();
